...
function Controller (model, view) {
    ...
    this.view.filterTasks(this.localStatus.bind(this))
    // this.view.FiletrUnchecked(this.handleToggleTodo.bind(this))
    // this.view.FilterAll(this.handleFilterAll.bind(this))
...
// Controller.prototype.handleFilterAll = function (status) {
//     this.model.switchFilter(status)
//    // alert(status)
// }
...
Controller.prototype.localStatus = function (status) {
    this.model.SaveRendStatus(status);
    //return this.view.displayTodos(todos);
}
